...
//        printf("Creating %i threads.\n", _dev_area.numq());
    ...
    ~Logger()
    {
        ...
        for(int i = 0; i < _dev_area.numq(); ++ i)
        {
            SLIM_DEBUGONLY(printf("Joining %i.\n", i);)

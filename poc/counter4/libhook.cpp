...
double regclock_now()
{
    ...
    {
        time = (now.tv_sec - ts_start.tv_sec) * 1000000000L;
        time += (now.tv_nsec - ts_start.tv_nsec);
    }
    else
    {
        time = (now.tv_sec - ts_start.tv_sec - 1) * 1000000000L;
        time += (1000000000 + now.tv_nsec - ts_start.tv_nsec);
    }
    return ((0.0)+time);
}

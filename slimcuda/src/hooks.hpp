...
DECLARE_HOOK_FUNC(cudaMallocManaged, (void **devPtr, size_t size, unsigned int flags))
DECLARE_HOOK_FUNC(cudaMallocPitch, (void **devPtr, size_t *pitch, size_t width, size_t height))

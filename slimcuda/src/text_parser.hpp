...
public:
	...
	public: // high level
		...
		enum class TokenType { Invalid, Whitespace, Newline, Punctuation, Identifier, HexNumber, DecNumber, Float, FloatBinary, Comment, EOS};
	...
	private:
        ...
        bool skip_comment()
        {
            ...
            if(c == '/')
            {
                ...
                while(c != '\n');
                return index.try_apply(&tmp, TokenType::Comment, 2);
            ...
            if(c == '*')
            {
                ...
                for(;;)
                {
                    ...
                    if(c == '*') last_star = true;
                        ...
                        return index.try_apply(&tmp, TokenType::Comment, 4, 0);
                    last_star = false;
                }
            }
            return false;
